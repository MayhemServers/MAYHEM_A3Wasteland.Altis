...
//_optionVehMenu= [[format ["%1 ($%2)",APOC_AA_VehOptions select 0, APOC_AA_VehOptions select 2]]]
_optionVehMenu append [[0], "", -5];
//_optionVehMenu= [[format ["%1 ($%2)",APOC_AA_VehOptions select 0, APOC_AA_VehOptions select 2]],[0],"",-5]
_optionVehMenu pushback ["expression", format ["[%1,%2,player] execVM "'addons\APOC_Airdrop_Assistance\APOC_cli_startAirdrop.sqf'"","veh",_i]];
//_optionVehMenu= [[format ["%1 ($%2)",APOC_AA_VehOptions select 0, APOC_AA_VehOptions select 2]],[0],"",-5,["expression", format ["[%1,%2,player] execVM "'addons\APOC_Airdrop_Assistance\APOC_cli_startAirdrop.sqf'"","veh",_i]]]
_optionVehMenu append ["1","1"];
//_optionVehMenu= [[format ["%1 ($%2)",APOC_AA_VehOptions select 0, APOC_AA_VehOptions select 2]],[0],"",-5,["expression", format ["[%1,%2,player] execVM "'addons\APOC_Airdrop_Assistance\APOC_cli_startAirdrop.sqf'"","veh",_i]],"1","1"]
VehicleMenu pushback _optionVehMenu;
diag_log VehicleMenu;
_i=_i+1;
}forEach APOC_AA_VehOptions;

_endVehMenu = ["Cancel Airdrop", [13], "", -3, [["expression", ""]], "1", "1"];
