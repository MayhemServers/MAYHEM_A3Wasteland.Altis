...
private ["_pos", "_dir", "_vector", "_attachTo", "_minDist"];
...
/*
{
	if (_x getVariable ["storeNPC_setupComplete", false] && {(getPos player) distance _x < _minDist}) exitWith
	{
		//if (_type in ["APERSTripMine_Wire_Mag", 
